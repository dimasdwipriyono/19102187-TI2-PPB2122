package com.dimasdwipriyono_19102187.lifecycleapp
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var btnpindah2 = findViewById(R.id.btnPage) as Button
        btnpindah2.setOnClickListener{
            val intent = Intent(this, activity_halaman_dua::class.java)
